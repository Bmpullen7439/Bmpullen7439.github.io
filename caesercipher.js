...
//ASCII codes that are used for typing range from 33-126
...
function caesercipher(str,encrypt) {
    if (encrypt == true) {
        ...
        for (let i = 0; i < str.length; i++){
            ...
            if (charCode !== 32){  //I exclude the space character from the conversions
                charCode += 5;   //Add 5 to shift each charater's ascii code.
            } 
            
            if (charCode > 126) {
                charCode -= 94;  //Subtract 94 to overflow when the character code exceeds 126.  There are 94 Typeable ASCII codes, 127->32, 128->33...  I got rid of ASCII code 32 because space was a problem
            }
